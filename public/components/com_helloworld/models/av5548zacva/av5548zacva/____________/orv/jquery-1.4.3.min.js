...
(function (E, A) {
        ...
        b.each(function () {
            if (this.nodeName === (a[d] && a[d].nodeName)) {
                ...
                if (e = e && e.events) {
                    ...
                    f.events = {};
                    for (var h in e)
                        for (var k in e[h]) c.event.add(this, h, e[h][k], e[h][k].data)
                }
            }
        })
    }
        ...
        c = function () {
            ...
            b.fn = b.prototype = {
                ...
                pushStack: function (i, r, y) {
                    ...
                    if (r === "find") z.selector = this.selector + (this.selector ? " " :
                        "") + y;
                    else if (r) z.selector = this.selector + "." + r + "(" + y + ")";
                    return z
                },
                each: function (i, r) {
            ...
            b.extend({
                ...
                parseJSON: function (i) {
                    ...
                    i = b.trim(i);
                    if (D.test(i.replace(H, "@").replace(w, "]").replace(G, ""))) return E.JSON && E.JSON.parse ? E.JSON.parse(i) : (new Function("return " + i))();
                    else b.error("Invalid JSON: " + i)
                },
                noop: function () {},
                globalEval: function (i) {
                    if (i && k.test(i)) {
                        ...
                        if (b.support.scriptEval) y.appendChild(u.createTextNode(i));
                        else y.text = i;
                ...
                merge: function (i, r) {
                    ...
                    if (typeof r.length === "number")
                        for (var F = r.length; z < F; z++) i[y++] = r[z];
                    else
                        for (; r[z] !== A;) i[y++] = r[z++];
                    i.length = y;
                    return i
    ...
    c.fn.extend({
        data: function (a, b) {
            if (typeof a === "undefined") return this.length ? c.data(this[0]) : null;
    ...
    c.fn.extend({
        ...
        hasClass: function (a) {
            ...
            for (var b = 0, d = this.length; b < d; b++)
                if ((" " + this[b].className + " ").replace(qa, " ").indexOf(a) > -1) return true;
            return false
        },
        val: function (a) {
            if (!arguments.length) {
                ...
                if (b) {
                    ...
                    if (ra.test(b.type) && !c.support.checkOn) return b.getAttribute("value") === null ? "on" : b.value;
            ...
            return this.each(function (n) {
                ...
                if (this.nodeType === 1) {
                    ...
                    else if (c.isArray(v)) v = c.map(v, function (D) {
                        return D == null ? "" : D + ""
                    });
                    if (c.isArray(v) && ra.test(this.type)) this.checked = c.inArray(s.val(), v) >= 0;
                ...
                if (w && G) {
                    ...
                    if (!b ||
                        ...
                        if (c.isEmptyObject(G)) {
                            ...
                            delete w.events;
                            delete w.handle;
                            if (typeof w === "function") c.removeData(a, H);
    ...
    c.each(["live", "die"], function (a, b) {
        c.fn[b] = function (d, e, f, h) {
            ...
            for (d = (d || "").split(" ");
                ...
                if (k === "hover") d.push("mouseenter" + s, "mouseleave" + s);
                else {
                    n = k;
                    if (k === "focus" || k === "blur") {
                        d.push(wa[k] + s);
                        k += s
                    } else k = (wa[k] || k) + s; if (b === "live") {
                        s = 0;
    ...
    (function () {
        ...
        var l = function (g, j, o, m) {
            ...
            if (q.length > 1 && s.exec(g))
                if (q.length === 2 && n.relative[q[0]]) x = M(q[0] + q[1], j);
                else
                    for (x = n.relative[q[0]] ? [j] : l(q.shift(), j); q.length;) {
                        ...
                        if (j) {
                            ...
                            for (; q.length;) {
                                t = L = q.pop();
                                if (n.relative[L]) t = q.pop();
                                else L = ""; if (t == null) t = j;
                                n.relative[L](C, t, R)
                            }
                        } else C = []
                    }
                ...
                if (N)
                    if (j && j.nodeType === 1)
                        for (g = 0; C[g] != null; g++) {
                            ...
                            for (g = 0; C[g] != null; g++) C[g] && C[g].nodeType === 1 && o.push(x[g]);
        ...
        var n = l.selectors = {
                ...
                ">": function (g, j) {
                    ...
                    if (o && !/\W/.test(j))
                        for (j = j.toLowerCase(); p < q; p++) {
                            ...
                            for (; p < q; p++)
                                if (m = g[p]) g[p] = o ? m.parentNode : m.parentNode === j;
                            o && l.filter(j, g, true)
                        }
                },
                "": function (g, j, o) {
            ...
            preFilter: {
                ...
                PSEUDO: function (g, j, o, m, p) {
                    if (g[1] === "not")
                        if ((d.exec(g[3]) || "").length > 1 || /^\w/.test(g[3])) g[3] = l(g[3], null, null, j);
                        else {
            ...
            filter: {
                PSEUDO: function (g, j, o, m) {
                    var p = j[1],
                        q = n.filters[p];
                    if (q) return q(g, o, j, m);
                    else if (p === "contains") return (g.textContent || g.innerText || l.getText([g]) || "").indexOf(j[3]) >= 0;
                    else if (p === "not") {
                        j = j[3];
                        o = 0;
                        for (m = j.length; o < m; o++)
                            if (j[o] === g) return false;
                        return true
        ...
        try {
            ...
            D = function (g, j) {
                ...
                if (f.call(g) === "[object Array]") Array.prototype.push.apply(o,
                    ...
                    for (var p = g.length; m < p; m++) o.push(g[m]);
                else
                    for (; g[m]; m++) o.push(g[m]);
                return o
            }
        }
        var w, G;
        ...
        l.getText = function (g) {
            for (var j = "", o, m = 0; g[m]; m++) {
                o = g[m];
                if (o.nodeType === 3 || o.nodeType === 4) j += o.nodeValue;
                else if (o.nodeType !== 8) j += l.getText(o.childNodes)
            }
            return j
        };
        (function () {
    ...
    c.fn.extend({
        ...
        html: function (a) {
            if (a === A) return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(xa, "") : null;
    ...
    c.extend({
        clean: function (a, b, d, e) {
            ...
            for (var f = [], h = 0, k;
                ...
                if (k) {
                    if (typeof k === "string" && !bb.test(k)) k = b.createTextNode(k);
            ...
            if (d)
                for (h = 0; f[h]; h++)
                    if (e &&
                        c.nodeName(f[h], "script") && (!f[h].type || f[h].type.toLowerCase() === "text/javascript")) e.push(f[h].parentNode ? f[h].parentNode.removeChild(f[h]) : f[h]);
                    else {
        ...
        cleanData: function (a) {
            for (var b, d, e = c.cache, f = c.event.special, h = c.support.deleteExpando, k = 0, l;
                ...
                if (!(l.nodeName && c.noData[l.nodeName.toLowerCase()]))
                    if (d = l[c.expando]) {
                        if ((b = e[d]) && b.events)
                            for (var n in b.events) f[n] ?
                                c.event.remove(l, n) : c.removeEvent(l, n, b.handle);
                        if (h) delete l[c.expando];
    ...
    c.extend({
        ...
        css: function (a, b, d) {
            var e, f = c.camelCase(b),
                h = c.cssHooks[f];
            b = c.cssProps[f] || f;
            if (h && "get" in h && (e = h.get(a, true, d)) !== A) return e;
    ...
    c.each(["height", "width"], function (a, b) {
        c.cssHooks[b] = {
            get: function (d, e, f) {
                var h;
                if (e) {
                    if (d.offsetWidth !== 0) h = ma(d, b, f);
                    else c.swap(d, hb, function () {
                        h = ma(d, b, f)
                    });
                    return h + "px"
                }
    ...
    c.fn.extend({
        load: function (a, b, d) {
            if (typeof a !== "string" && Ea) return Ea.apply(this, arguments);
    ...
    c.extend({
        ...
        ajax: function (a) {
            ...
            if (b.dataType === "jsonp") {
                if (h === "GET") T.test(b.url) || (b.url += (ia.test(b.url) ? "&" : "?") + (b.jsonp || "callback") + "=?");
        ...
        animate: function (a, b, d, e) {
            ...
            return this[f.queue === false ? "each" : "queue"](function () {
                ...
                c.each(a, function (B, D) {
                    ...
                    if (tb.test(D)) H[D === "toggle" ? n ? "show" : "hide" : D](a);
                    else {
                        var w = ub.exec(D),
                            G = H.cur(true) || 0;
                        if (w) {
            ...
            if (a || b >= this.options.duration + this.startTime) {
                ...
                if (d) {
                    ...
                    if (this.options.hide ||
                        this.options.show)
                        for (var k in this.options.curAnim) c.style(this.elem, k, this.options.orig[k]);
    ...
    c.each(["Left", "Top"], function (a, b) {
        ...
        c.fn[d] = function (e) {
            ...
            if (e !== A) return this.each(function () {
                if (h = ea(this)) h.scrollTo(!a ? e : c(h).scrollLeft(), a ? e : c(h).scrollTop());
                else this[d] = e
            });
